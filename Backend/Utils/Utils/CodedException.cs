    ...
    where T : unmanaged, Enum, IConvertible
{
    ...
    public CodedException(string message, T code) : base(message)
    {
        Code = code;
    }
    ...
    /// </param>
    public CodedException(string message, T code, Exception innerException) : base(message, innerException)
    {
        Code = code;
    }
}