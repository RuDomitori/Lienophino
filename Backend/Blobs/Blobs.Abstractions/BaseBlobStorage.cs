...
{
    /// <inheritdoc/>
    public abstract Task<Stream> OpenRead(Guid blobId, CancellationToken cancellationToken = default);
    
    /// <inheritdoc/>
    public abstract Task<Stream> OpenReadWrite(Guid blobId, CancellationToken cancellationToken = default);
    
    /// <inheritdoc/>
    public abstract Task<Stream> Create(Guid blobId, CancellationToken cancellationToken = default);
    
    /// <inheritdoc/>
    public virtual async Task<Stream> CreateOrReplace(Guid blobId, CancellationToken cancellationToken = default)
    {
        if (blobId == default)
    ...
    /// <inheritdoc/>
    public virtual async Task<int> CreateOrReplace(Guid blobId, Stream stream, CancellationToken cancellationToken = default)
    {
        await using (stream)
        {
            if (blobId == default)
    ...
    /// <inheritdoc/>
    public virtual async Task<int> Create(Guid blobId, Stream stream, CancellationToken cancellationToken = default)
    {
        await using (stream)
        {
            if (blobId == default)
    ...
    /// <inheritdoc/>
    public virtual async Task<bool> RemoveIfExist(Guid blobId, CancellationToken cancellationToken = default)
    {
        if (blobId == default)
            throw new ArgumentException($"{nameof(blobId)} must be not default", nameof(blobId));
    ...
    /// <inheritdoc/>
    public virtual async Task Move(Guid oldBlobId, Guid newBlobId, CancellationToken cancellationToken = default)
    {
